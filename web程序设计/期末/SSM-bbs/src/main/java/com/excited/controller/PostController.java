...
public class PostController {
    ...
    public String doLike(int postId){
        postService.doLike(postId);
        return "redirect:postContent-" + postId;
    }
    @RequestMapping(value = "/doHate")
    public String doHate(int postId){
        postService.doHate(postId);
        return "redirect:postContent-" + postId;
    }
}
