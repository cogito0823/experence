...
<div class="mdl-layout mdl-js-layout">
    <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--grey-50">
        <div class="mdl-layout__header-row">
            <!-- Title -->
            <a class="mdl-layout-title mdl-navigation__link mdl-color-text--pink-400" href="/">板块</a>
            ...
            <c:forEach items="${board}" var="board" varStatus="status">
                <div class="mdl-grid">
                    ...
                    <div class="mdl-cell mdl-cell--6-col">
                        <div class="card-width center mdl-card mdl-shadow--2dp" style="background-image: url('../resources/img/${board.boardId}.png');background-size:70%;background-repeat: repeat">
