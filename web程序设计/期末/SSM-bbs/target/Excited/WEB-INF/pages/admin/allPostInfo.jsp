                    ...
                    <div class="center mdl-cell--12-col">
                        <table class="center mdl-data-table mdl-js-data-table mdl-shadow--2dp" align="center">
                            ...
                            <tr>
                                ...
                                <td width="100px">
                                    <a href="/user/listUserInfo?username=${post.postUserName}">${post.postUserName}</a>
                                </td>
                                <td>${post.postBoardId}</td>
                                <td>${post.postReplyCount}</td>
                                <td>${post.postViewCount}</td>
                                <td>${post.postCreateTime}</td>
                                <td>
                                    <c:if  test="${post.postIfBest==0}">
                                        <div class="">
                                            <a class=""
                                               href="/admin/doBest?postId=${post.postId}">否</a>
                                        </div>
                                    </c:if>
                                    <c:if  test="${post.postIfBest!=0}">
                                        <div class="">
                                            <a class=""
                                               href="/admin/deBest?postId=${post.postId}">是</a>
                                        </div>
                                    </c:if>
                                </td>
                                <td>
                                    <c:if  test="${post.postIfTop==0}">
                                        <div class="">
                                            <a class=""
                                               href="/admin/doTop?postId=${post.postId}">否</a>
                                        </div>
                                    </c:if>
                                    <c:if  test="${post.postIfTop!=0}">
                                        <div class="">
                                            <a class=""
                                               href="/admin/deTop?postId=${post.postId}">是</a>
                                        </div>
                                    </c:if>
                                </td>
                                <td>
