...
<div class="mdl-layout mdl-js-layout">
    <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--grey-50">
        <div class="mdl-layout__header-row">
            <!-- Title -->
            <a class="mdl-layout-title mdl-navigation__link mdl-color-text--pink-400" href="/">主页</a>
        ...
        <div class="page-content">
            ...
            <div class="mdl-grid">
                <c:forEach items="${board}" var="board" varStatus="status">
                    ...
                    <div onclick="window.location.href= '/board/listPosts-${board.boardId}';return false" class="mdl-card mdl-shadow--2dp center">
                    <div class="mdl-card__title mdl-card--expand">
                    <img src="../resources/img/${board.boardId}.png" width="60%" style="margin: auto"/>
                    </div>
